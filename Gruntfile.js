module.exports = function(grunt) {
  ...
  // BEGIN ... these lines removed because we're not doing testing and don't need Karma
  ...
  //  END ... the above lines could be useful for testing, though newer app-kit doesn't use Karma.
